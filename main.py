...
if FLAG_PLATFORM == 'colab':
    ...
    parser.add_argument('--dir_checkpoint', default='./drive/My Drive/GitHub/pytorch-cnp/checkpoints', dest='dir_checkpoint')
    parser.add_argument('--dir_log', default='./drive/My Drive/GitHub/pytorch-cnp/log', dest='dir_log')
    parser.add_argument('--dir_result', default='./drive/My Drive/GitHub/pytorch-cnp/results', dest='dir_result')
...
parser.add_argument('--scope', default='cnp', dest='scope')
...
parser.add_argument('--num_freq_disp', type=int,  default=3, dest='num_freq_disp')
